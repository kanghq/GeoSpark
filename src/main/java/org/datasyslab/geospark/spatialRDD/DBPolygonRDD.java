/**
 * FILE: DBPolygonRDD.java
 * PATH: org.datasyslab.geospark.spatialRDD.DBPolygonRDD.java
 * All rights reserved.
 */
 ...
 */
public class DBPolygonRDD extends DBSpatialRDD {
    


    public int DBserverNumber = 4;
     ...
     */
	@Deprecated
    public DBPolygonRDD(JavaRDD<Polygon> rawSpatialRDD) {
     ...
     */
	@Deprecated
    public DBPolygonRDD(JavaSparkContext sparkContext, String InputLocation, Integer startOffset, Integer endOffset, FileDataSplitter splitter, boolean carryInputData, Integer partitions) {
     ...
     */
	@Deprecated
    public DBPolygonRDD(JavaSparkContext sparkContext, String InputLocation, Integer startOffset, Integer endOffset, FileDataSplitter splitter, boolean carryInputData) {
     ...
     */
	@Deprecated
    public DBPolygonRDD(JavaSparkContext sparkContext, String InputLocation, FileDataSplitter splitter, boolean carryInputData, Integer partitions) {
     ...
     */
	@Deprecated
    public DBPolygonRDD(JavaSparkContext sparkContext, String InputLocation, FileDataSplitter splitter, boolean carryInputData) {
     ...
     */
	@Deprecated
    public DBPolygonRDD(JavaSparkContext sparkContext, String InputLocation, Integer partitions, FlatMapFunction userSuppliedMapper) {
     ...
     */
	@Deprecated
    public DBPolygonRDD(JavaSparkContext sparkContext, String InputLocation, FlatMapFunction userSuppliedMapper) {
     ...
     */
    public DBPolygonRDD(JavaRDD<Polygon> rawSpatialRDD, StorageLevel newLevel, int neSrv) {
    	this.DBserverNumber  = neSrv;
		this.rawSpatialRDD = rawSpatialRDD.map(new Function<Polygon,Object>()
		{
			@Override
			public Object call(Polygon spatialObject) throws Exception {
     ...
     * @param newLevel the new level
     */
    public DBPolygonRDD(JavaSparkContext sparkContext, String InputLocation, Integer startOffset, Integer endOffset,
     ...
     * @param newLevel the new level
     */
    public DBPolygonRDD(JavaSparkContext sparkContext, String InputLocation,
    		FileDataSplitter splitter, boolean carryInputData, Integer partitions, StorageLevel newLevel) {
        this.setRawSpatialRDD(sparkContext.textFile(InputLocation, partitions).flatMap(new PolygonFormatMapper(splitter,carryInputData)));
        this.analyze(newLevel);
    }
     ...
     * @param newLevel the new level
     */
    public DBPolygonRDD(JavaSparkContext sparkContext, String InputLocation, Integer partitions, FlatMapFunction userSuppliedMapper, StorageLevel newLevel) {
        this.setRawSpatialRDD(sparkContext.textFile(InputLocation, partitions).flatMap(userSuppliedMapper));
        this.analyze(newLevel);
    }
     ...
     * @param newLevel the new level
     */
    public DBPolygonRDD(JavaSparkContext sparkContext, String InputLocation, FlatMapFunction userSuppliedMapper, StorageLevel newLevel) {
        this.setRawSpatialRDD(sparkContext.textFile(InputLocation).flatMap(userSuppliedMapper));
        this.analyze(newLevel);
    }
